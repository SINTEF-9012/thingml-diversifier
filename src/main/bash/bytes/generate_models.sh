...
function generate
{
  ...
  java -jar $DIVERSIFIER -i $BASEMODEL -r 1 -n $N -m static -o $MODELSDIR/$LANGUAGE/nolog/static -s shuff-msg -s shuff-param -s dup-msg -s split-msg -s code-msg
  ...
  java -jar $DIVERSIFIER -i $BASEMODEL -r 1 -n $N -m dynamic -o $MODELSDIR/$LANGUAGE/nolog/dynamic -s shuff-msg -s shuff-param -s dup-msg -s split-msg -s code-msg
