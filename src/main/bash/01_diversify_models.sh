...
for LANGUAGE in ${LANGUAGES[@]}; do
  _docker run -v $BASEDIR:/thingml-div thingml-div thingml --tool monitor-bin --output /thingml-div/target/models/$LANGUAGE --source /thingml-div/src/main/resources/experiments1/$LANGUAGE.thingml
