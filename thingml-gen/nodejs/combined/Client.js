...
function Client(name, root, Client_counter_var, Client_start_var, Client__b_var, Client__a_var, Client__d_var, Client__e_var, Client__c_var, debug) {
	this.name = name;
...
Client.prototype.build = function(session) {
	...
	let Client_null_generate_m3_from_m3__and_m3r4r5r2r3a_INIT_S4 = new StateJS.State('S4', Client_null_generate_m3_from_m3__and_m3r4r5r2r3a_INIT).entry(() => {
		setImmediate(() => this.bus.emit('diversified?m3', this.Client_null_generate_m3_from_m3__and_m3r4r5r2r3a_INIT_r4_var, this.Client_null_generate_m3_from_m3__and_m3r4r5r2r3a_INIT_r5_var, this.Client_null_generate_m3_from_m3__and_m3r4r5r2r3a_INIT_r2_var, this.Client_null_generate_m3_from_m3__and_m3r4r5r2r3a_INIT_r3_var, this.Client_null_generate_m3_from_m3__and_m3r4r5r2r3a_INIT_a_var));
	});
	...
	let Client_null_generate_m3bis_from_m3bis__and_m3bisr4r5r2r3a_INIT_S4 = new StateJS.State('S4', Client_null_generate_m3bis_from_m3bis__and_m3bisr4r5r2r3a_INIT).entry(() => {
		setImmediate(() => this.bus.emit('diversified?m3bis', this.Client_null_generate_m3bis_from_m3bis__and_m3bisr4r5r2r3a_INIT_r4_var, this.Client_null_generate_m3bis_from_m3bis__and_m3bisr4r5r2r3a_INIT_r5_var, this.Client_null_generate_m3bis_from_m3bis__and_m3bisr4r5r2r3a_INIT_r2_var, this.Client_null_generate_m3bis_from_m3bis__and_m3bisr4r5r2r3a_INIT_r3_var, this.Client_null_generate_m3bis_from_m3bis__and_m3bisr4r5r2r3a_INIT_a_var));
	});
	...
	let Client_null_RUN = new StateJS.State('RUN', this._statemachine).entry(() => {
		...
		process.stdout.write(''+', ');
		process.stderr.write('\n');
		setImmediate(() => this.bus.emit('app?m1abcd', this.Client__a_var, this.Client__b_var, this.Client__c_var, this.rnd(), this.Client__d_var));
		...
		process.stdout.write(''+', ');
		process.stderr.write('\n');
		setImmediate(() => this.bus.emit('app?m1e', this.rnd(), this.rnd(), this.rnd(), this.rnd(), this.Client__e_var));
		...
		process.stdout.write(''+', ');
		process.stderr.write('\n');
		setImmediate(() => this.bus.emit('app?m1bisabcd', this.Client__a_var, this.rnd(), this.Client__b_var, this.Client__c_var, this.Client__d_var));
		process.stdout.write(''+'17');
		process.stdout.write(''+', ');
		process.stdout.write(''+this.rnd());
		process.stdout.write(''+', ');
		process.stdout.write(''+this.rnd());
		...
		process.stdout.write(''+', ');
		process.stderr.write('\n');
		setImmediate(() => this.bus.emit('app?m1bise', this.rnd(), this.rnd(), this.rnd(), this.rnd(), this.Client__e_var));
		...
		process.stdout.write(''+', ');
		process.stderr.write('\n');
		setImmediate(() => this.bus.emit('app?m2r0r1', this.rnd(), this.rnd(), this.rnd(), this.rnd(), this.rnd()));
		...
		process.stdout.write(''+', ');
		process.stderr.write('\n');
		setImmediate(() => this.bus.emit('app?m2abc', this.Client__a_var, this.rnd(), this.Client__b_var, this.rnd(), this.Client__c_var));
		...
		process.stdout.write(''+', ');
		process.stderr.write('\n');
		setImmediate(() => this.bus.emit('app?m2bisr0r1ab', this.rnd(), this.rnd(), this.rnd(), this.Client__a_var, this.Client__b_var));
		...
		process.stdout.write(''+', ');
		process.stderr.write('\n');
		setImmediate(() => this.bus.emit('app?m2bisc', this.rnd(), this.rnd(), this.rnd(), this.rnd(), this.Client__c_var));
