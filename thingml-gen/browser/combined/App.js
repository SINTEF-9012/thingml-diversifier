...
App.prototype.build = function(session) {
	...
	let App_null_generate_m2_from_m2r0r1_and_m2abc_INIT_S4 = new StateJS.State('S4', App_null_generate_m2_from_m2r0r1_and_m2abc_INIT).entry(() => {
		setTimeout(() => this.bus.emit('diversified?m2', this.App_null_generate_m2_from_m2r0r1_and_m2abc_INIT_r0_var, this.App_null_generate_m2_from_m2r0r1_and_m2abc_INIT_r1_var, this.App_null_generate_m2_from_m2r0r1_and_m2abc_INIT_a_var, this.App_null_generate_m2_from_m2r0r1_and_m2abc_INIT_b_var, this.App_null_generate_m2_from_m2r0r1_and_m2abc_INIT_c_var), 0);
	});
	...
	let App_null_generate_m1_from_m1abcd_and_m1e_INIT_S4 = new StateJS.State('S4', App_null_generate_m1_from_m1abcd_and_m1e_INIT).entry(() => {
		setTimeout(() => this.bus.emit('diversified?m1', this.App_null_generate_m1_from_m1abcd_and_m1e_INIT_a_var, this.App_null_generate_m1_from_m1abcd_and_m1e_INIT_b_var, this.App_null_generate_m1_from_m1abcd_and_m1e_INIT_c_var, this.App_null_generate_m1_from_m1abcd_and_m1e_INIT_d_var, this.App_null_generate_m1_from_m1abcd_and_m1e_INIT_e_var), 0);
	});
	...
	let App_null_generate_m2bis_from_m2bisr0r1ab_and_m2bisc_INIT_S4 = new StateJS.State('S4', App_null_generate_m2bis_from_m2bisr0r1ab_and_m2bisc_INIT).entry(() => {
		setTimeout(() => this.bus.emit('diversified?m2bis', this.App_null_generate_m2bis_from_m2bisr0r1ab_and_m2bisc_INIT_r0_var, this.App_null_generate_m2bis_from_m2bisr0r1ab_and_m2bisc_INIT_r1_var, this.App_null_generate_m2bis_from_m2bisr0r1ab_and_m2bisc_INIT_a_var, this.App_null_generate_m2bis_from_m2bisr0r1ab_and_m2bisc_INIT_b_var, this.App_null_generate_m2bis_from_m2bisr0r1ab_and_m2bisc_INIT_c_var), 0);
	});
	...
	let App_null_SendAck = new StateJS.State('SendAck', this._statemachine).entry(() => {
		...
		if(this.rnd() < 74) {
		if(this.rnd() < 69) {
		console.log(''+'8'+', '+this.rnd()+', '+this.rnd()+', '+this.rnd()+', '+this.rnd()+', '+this.rnd()+', ');
		setTimeout(() => this.bus.emit('app?m3_', this.rnd(), this.rnd(), this.rnd(), this.rnd(), this.rnd()), 0);
		console.log(''+'9'+', '+this.rnd()+', '+this.rnd()+', '+this.rnd()+', '+this.rnd()+', '+this.App_id_var+', ');
		setTimeout(() => this.bus.emit('app?m3r4r5r2r3a', this.rnd(), this.rnd(), this.rnd(), this.rnd(), this.App_id_var), 0);
		...
		if(this.rnd() < 248) {
		console.log(''+'14'+', '+this.rnd()+', '+this.rnd()+', '+this.rnd()+', '+this.rnd()+', '+this.rnd()+', ');
		setTimeout(() => this.bus.emit('app?m3bis_', this.rnd(), this.rnd(), this.rnd(), this.rnd(), this.rnd()), 0);
		console.log(''+'15'+', '+this.rnd()+', '+this.rnd()+', '+this.rnd()+', '+this.rnd()+', '+this.App_id_var+', ');
		setTimeout(() => this.bus.emit('app?m3bisr4r5r2r3a', this.rnd(), this.rnd(), this.rnd(), this.rnd(), this.App_id_var), 0);
	...
	App_null_WaitForM2.to(App_null_SendAck).when((m2bis) => {
		...
		console.log(''+'#APP: Ooh, I needed that app?m2('+m2bis.a+', '+m2bis.b+', '+m2bis.c+')!');
	});
	...
	App_null_WaitForM1.to(App_null_WaitForM2).when((m1bis) => {
		...
		this.bus.emit('id=', this.App_id_var);
		console.log(''+'#APP: Ooh, I needed that app?m1('+m1bis.a+', '+m1bis.b+', '+m1bis.c+', '+m1bis.d+', '+m1bis.e+')!');
	});
